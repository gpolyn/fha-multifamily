...
describe Sec223fMultifamilyElevatorStatLimitSet do
  it "should include Sec223fMultifamilyStatLimitSetValidations" do
    (Sec223fMultifamilyElevatorStatLimitSet < Sec223fMultifamilyStatLimitSetValidations).should be true
  end
end

# describe Sec223fMultifamilyElevatorStatLimitSet, "validations" do
#   
#   let(:attrs) {{:zero_bedroom=>0, :one_bedroom=>0, :two_bedroom=>0, :three_bedroom=>0, :four_bedroom=>0}}
#   
#   before(:each) {@stat_limit_set = Sec223fMultifamilyElevatorStatLimitSet.new attrs}
# 
