module Sec223fPurchase
  ...
  def initialize(input={})
    ...
    if criterion_11
      ...
      criterion_11.merge!(criterion_7)
    ...
    # p "lease is valid? #{sec223f_acquisition.lease.valid?}"
    # p "lease errors #{sec223f_acquisition.lease.errors.full_messages}"
  end
  ...
  def valid?
    ...
    lease_valid = (sec223f_acquisition.lease && !sec223f_acquisition.lease.valid?) ? false : true
    tax_abatement_valid = (sec223f_acquisition.tax_abatement && !sec223f_acquisition.tax_abatement.valid?) ? false : true
    sec223f_acquisition.valid? && lease_valid && tax_abatement_valid &&
