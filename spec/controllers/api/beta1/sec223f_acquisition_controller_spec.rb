...
describe Api::Beta1::Sec223fAcquisitionController, "#loan" do
  
  it "should have expected route", :type=>:routing do
    assert_routing({:path=>"api/beta1/sec223f_acquisition", :method =>:post}, 
                   {:controller=>"api/beta1/sec223f_acquisition", :action =>"loan"})
  end
