...
# 
#     describe "#purchase_price_including_loan_closing_charges" do
#       specify {@lambda = lambda {host.purchase_price_including_loan_closing_charges}}
#     end
# 
...
#     it "should be an alias for purchase_price_including_loan_closing_charges" do
#       host.should_receive(:purchase_price_including_loan_closing_charges).and_return some_int
